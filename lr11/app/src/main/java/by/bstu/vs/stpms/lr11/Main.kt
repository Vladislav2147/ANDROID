...
fun main(args: Array<String>) {
    ...
    //F
    println("task3F")
    println("abababa".coincidence("ab"))
    ...
    try{
        ...
        when {
            date.equals(null) -> {
                ...
                val formattedDate = dateObj!!.format(formatter)
                val dayMonth = formattedDate.substring(0, 5)
                when(dayMonth){
...
fun String.coincidence(substring: String) = Regex(substring).findAll(this).toList().size